...
const GestisciPatrimonioCondiviso = () => {
  const { categorie, setCategorie } = useSharedWorkspace();
  ...
  const handleSave = async () => {
    ...
    toast.success("Categorie condivise aggiornate ✅");
    navigate(-1);
  };
  ...
  return (
    ...
    >
      ...
      <h1 className="text-2xl font-semibold tracking-tight mb-6">Gestisci Patrimonio Condiviso 🏦</h1>
...
export default GestisciPatrimonioCondiviso;
