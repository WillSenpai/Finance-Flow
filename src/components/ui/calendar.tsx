    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-card p-0 opacity-70 hover:opacity-100 border-border rounded-xl",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-xl w-9 font-medium text-[0.75rem] uppercase",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-xl hover:bg-muted"),
        ...
        dropdown: "bg-card border border-border rounded-xl px-2 py-1 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
        dropdown_month: "mr-1",
        dropdown_year: "",
