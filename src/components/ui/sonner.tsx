  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "financeflow-toast group pointer-events-auto relative flex w-[min(90vw,400px)] items-center gap-3 overflow-hidden rounded-2xl border border-border/50 bg-background px-4 pr-10 py-3.5 pb-[1.15rem] text-foreground shadow-[0_8px_40px_-12px_hsl(var(--foreground)/0.22),0_2px_12px_-4px_hsl(var(--foreground)/0.10)] backdrop-blur-xl",
